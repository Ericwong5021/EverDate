...
export default function DesignSystemPage() {
  return (
    <main className="container py-8">
      <h1 className="text-4xl font-bold mb-8 font-[var(--font-serif)]">
        EverDate 设计系统
      </h1>

      {/* Colors Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-6 font-[var(--font-serif)]">色彩系统</h2>

        <div className="mb-6">
          <h3 className="text-lg font-medium mb-3">酒红 (Wine)</h3>
        ...
        <div className="mb-6">
          <h3 className="text-lg font-medium mb-3">玫瑰金 (Rose Gold)</h3>
          <div className="flex flex-wrap gap-2">
            {[
        ...
        <div>
          <h3 className="text-lg font-medium mb-3">奶油白 (Cream)</h3>
          <div className="flex flex-wrap gap-2">
            {[
      ...
      {/* Typography Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-6 font-[var(--font-serif)]">字体系统</h2>

        <div className="space-y-4">
          <div>
            <h3 className="text-lg font-medium mb-2">衬线字体 (Serif)</h3>
            <p className="text-4xl font-[var(--font-serif)] mb-2">
              Playfair Display / 思源宋体
            </p>
          ...
          <div>
            <h3 className="text-lg font-medium mb-2">无衬线字体 (Sans-serif)</h3>
            <p className="text-4xl font-[var(--font-sans)] mb-2">
              Inter / 系统字体
            </p>
            <p className="text-sm text-gray-600">
              用于正文、表单等需要清晰可读性的场景
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
            {[
              ...
              <div key={item.size} className="p-3 bg-gray-50 rounded-lg">
      ...
      {/* Spacing Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-6 font-[var(--font-serif)]">间距系统</h2>
      ...
      {/* Components Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-6 font-[var(--font-serif)]">组件库</h2>

        {/* Buttons */}
        <div className="mb-8">
          <h3 className="text-lg font-medium mb-4">按钮 (Button)</h3>
        ...
        {/* Cards */}
        <div className="mb-8">
          <h3 className="text-lg font-medium mb-4">卡片 (Card)</h3>
        ...
        {/* Forms */}
        <div className="mb-8">
          <h3 className="text-lg font-medium mb-4">表单 (Form)</h3>
        ...
        {/* Badges */}
        <div className="mb-8">
          <h3 className="text-lg font-medium mb-4">徽章 (Badge)</h3>
          <div className="flex flex-wrap gap-2">
      ...
      {/* Shadows Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-6 font-[var(--font-serif)]">阴影效果</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            >
              ...
              <p className="text-xs text-gray-500 mt-1">{item.shadow}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold mb-6 font-[var(--font-serif)]">圆角</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={item.name} className="p-4 bg-gray-100">
              <div
