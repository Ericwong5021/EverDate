        ...
        <div className="container">
          <div className="max-w-lg mx-auto">
            <div className="text-center mb-8">
              <Badge variant="gold" className="mb-4">倒计时</Badge>
            ...
            <div className="relative mb-8">
              ...
              <Card variant="elevated" className="relative text-center p-8">
                <p className="text-sm text-[var(--color-muted-foreground)] font-[var(--font-ui)] mb-4">
                  距离结婚纪念日还有
                </p>
                ...
                <div className="flex justify-center gap-6 mb-6">
                  {[
                    ...
                    <div key={item.label} className="text-center">
                      <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-[16px] bg-[var(--color-muted)] flex items-center justify-center mb-2">
                        <span className="font-[var(--font-title)] text-3xl sm:text-4xl font-light text-[var(--color-primary)]">
