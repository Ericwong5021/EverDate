...
export function Button({
  ...
  const variants = {
    primary: "bg-wine-700 text-white hover:bg-wine-800 focus:ring-wine-500",
    secondary: "border-2 border-wine-700 text-wine-700 hover:bg-wine-50 focus:ring-wine-500",
    ghost: "text-wine-700 hover:bg-wine-50 focus:ring-wine-500",
  };
